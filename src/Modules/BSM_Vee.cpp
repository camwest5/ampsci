            ...
            for (int tma = -Fa.twoj(); tma <= Fa.twoj(); tma += 2) {
              for (int tmn = -Fn.twoj(); tmn <= Fn.twoj(); tmn += 2) {
                ...
                const auto dir_CC_AV =
                    Angular::Ck_kk_mmq(k, Fn.kappa(), -Fv.kappa(), tmn, tmv,
                                       tq) *
                    Angular::Ck_kk_mmq(k, Fa.kappa(), Fa.kappa(), tma, tma,
                                       -tq);
                ...
                const auto exch_CC_AV =
                    Angular::Ck_kk_mmq(k, Fn.kappa(), -Fa.kappa(), tmn, tma,
                                       tq) *
                    Angular::Ck_kk_mmq(k, Fa.kappa(), Fv.kappa(), tma, tmv,
                                       -tq);
